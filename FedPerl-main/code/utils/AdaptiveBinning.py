'''
This code from paper Ding, Y., Liu, J., Xiong, J., Shi, Y., 2020. Revisiting the evaluation of uncertainty estimation and its application to explore model complexityuncertainty
trade-of, in: Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition Workshops, pp. 4–5. 
'''

import matplotlib.pyplot as plt


def AdaptiveBinning(infer_results, show_reliability_diagram = True, name='Rd'):
	'''
	...
	if show_reliability_diagram:
		...
		# plt.show()
        # f1.savefig('comparison.png', dpi=200) 
		f1.savefig(name, dpi=200)
